...
(
    ...
    status           int      default 1                 not null comment '0:启动 1关闭',
    creator          int                                not null comment '创建人',
    create_time      datetime default CURRENT_TIMESTAMP not null comment '创建时间',
    updater          int                                not null comment '更新人',
    update_time      datetime default CURRENT_TIMESTAMP not null on update CURRENT_TIMESTAMP comment '更新时间',
...
(
    ...
    status      int      default 1                 not null comment '状态 0:已连接 1:未连接',
    auto_connect bit      default b'1'              null comment '是否自启动0:是 1:否',
    creator     int                                not null comment '创建人',
    create_time datetime default CURRENT_TIMESTAMP not null comment '创建时间',
    updater     int                                not null comment '更新人',
    update_time datetime default CURRENT_TIMESTAMP not null on update CURRENT_TIMESTAMP comment '更新时间',
